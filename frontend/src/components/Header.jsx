...
// Assuming you might want to add dynamic content later, like a user's name or task count.

export default function Header({ taskCount = 5 }) { 
  return (
    // Card Style: Pure White BG, maximum elevation (shadow-2xl), large soft corners (rounded-xl)
    <div className="bg-white p-6 rounded-xl shadow-2xl flex justify-between items-center mb-8 
      ...
      {/* Title: Strong Brand Color and Font Weight */}
      <h1 className="text-3xl font-extrabold text-[#0047AB] tracking-tight">
        📋 Your Active Tasks
      </h1>
      
      {/* Secondary Info/Call to Action */}
      <div className="flex items-center space-x-3">
        {/* Placeholder for Dynamic Content (e.g., Task Count) */}
